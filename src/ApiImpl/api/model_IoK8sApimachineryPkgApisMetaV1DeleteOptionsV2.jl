...
"""
mutable struct IoK8sApimachineryPkgApisMetaV1DeleteOptionsV2 <: SwaggerModel
    ...
    function IoK8sApimachineryPkgApisMetaV1DeleteOptionsV2(;apiVersion=nothing, dryRun=nothing, gracePeriodSeconds=nothing, kind=nothing, orphanDependents=nothing, preconditions=nothing, propagationPolicy=nothing)
        o = new()
        validate_property(IoK8sApimachineryPkgApisMetaV1DeleteOptionsV2, Symbol("apiVersion"), apiVersion)
        setfield!(o, Symbol("apiVersion"), apiVersion)
        validate_property(IoK8sApimachineryPkgApisMetaV1DeleteOptionsV2, Symbol("dryRun"), dryRun)
        setfield!(o, Symbol("dryRun"), dryRun)
        validate_property(IoK8sApimachineryPkgApisMetaV1DeleteOptionsV2, Symbol("gracePeriodSeconds"), gracePeriodSeconds)
        setfield!(o, Symbol("gracePeriodSeconds"), gracePeriodSeconds)
        validate_property(IoK8sApimachineryPkgApisMetaV1DeleteOptionsV2, Symbol("kind"), kind)
        setfield!(o, Symbol("kind"), kind)
        validate_property(IoK8sApimachineryPkgApisMetaV1DeleteOptionsV2, Symbol("orphanDependents"), orphanDependents)
        setfield!(o, Symbol("orphanDependents"), orphanDependents)
        validate_property(IoK8sApimachineryPkgApisMetaV1DeleteOptionsV2, Symbol("preconditions"), preconditions)
        setfield!(o, Symbol("preconditions"), preconditions)
        validate_property(IoK8sApimachineryPkgApisMetaV1DeleteOptionsV2, Symbol("propagationPolicy"), propagationPolicy)
        setfield!(o, Symbol("propagationPolicy"), propagationPolicy)
        o
    end
end # type IoK8sApimachineryPkgApisMetaV1DeleteOptionsV2

const _property_map_IoK8sApimachineryPkgApisMetaV1DeleteOptionsV2 = Dict{Symbol,Symbol}(Symbol("apiVersion")=>Symbol("apiVersion"), Symbol("dryRun")=>Symbol("dryRun"), Symbol("gracePeriodSeconds")=>Symbol("gracePeriodSeconds"), Symbol("kind")=>Symbol("kind"), Symbol("orphanDependents")=>Symbol("orphanDependents"), Symbol("preconditions")=>Symbol("preconditions"), Symbol("propagationPolicy")=>Symbol("propagationPolicy"))
...
Base.propertynames(::Type{ IoK8sApimachineryPkgApisMetaV1DeleteOptionsV2 }) = collect(keys(_property_map_IoK8sApimachineryPkgApisMetaV1DeleteOptionsV2))
Swagger.property_type(::Type{ IoK8sApimachineryPkgApisMetaV1DeleteOptionsV2 }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApimachineryPkgApisMetaV1DeleteOptionsV2[name]))}
Swagger.field_name(::Type{ IoK8sApimachineryPkgApisMetaV1DeleteOptionsV2 }, property_name::Symbol) =  _property_map_IoK8sApimachineryPkgApisMetaV1DeleteOptionsV2[property_name]

function check_required(o::IoK8sApimachineryPkgApisMetaV1DeleteOptionsV2)
    true
end

function validate_property(::Type{ IoK8sApimachineryPkgApisMetaV1DeleteOptionsV2 }, name::Symbol, val)
end
