...
mutable struct IoK8sApiAutoscalingV2beta2MetricStatus <: SwaggerModel
    containerResource::Any # spec type: Union{ Nothing, IoK8sApiAutoscalingV2beta2ContainerResourceMetricStatus } # spec name: containerResource
    ...
    function IoK8sApiAutoscalingV2beta2MetricStatus(;containerResource=nothing, external=nothing, object=nothing, pods=nothing, resource=nothing, type=nothing)
        o = new()
        validate_property(IoK8sApiAutoscalingV2beta2MetricStatus, Symbol("containerResource"), containerResource)
...
const _property_map_IoK8sApiAutoscalingV2beta2MetricStatus = Dict{Symbol,Symbol}(Symbol("containerResource")=>Symbol("containerResource"), Symbol("external")=>Symbol("external"), Symbol("object")=>Symbol("object"), Symbol("pods")=>Symbol("pods"), Symbol("resource")=>Symbol("resource"), Symbol("type")=>Symbol("type"))
const _property_types_IoK8sApiAutoscalingV2beta2MetricStatus = Dict{Symbol,String}(Symbol("containerResource")=>"IoK8sApiAutoscalingV2beta2ContainerResourceMetricStatus", Symbol("external")=>"IoK8sApiAutoscalingV2beta2ExternalMetricStatus", Symbol("object")=>"IoK8sApiAutoscalingV2beta2ObjectMetricStatus", Symbol("pods")=>"IoK8sApiAutoscalingV2beta2PodsMetricStatus", Symbol("resource")=>"IoK8sApiAutoscalingV2beta2ResourceMetricStatus", Symbol("type")=>"String")
