...
mutable struct IoK8sApiNetworkingV1beta1IngressBackend <: SwaggerModel
    ...
    function IoK8sApiNetworkingV1beta1IngressBackend(;resource=nothing, serviceName=nothing, servicePort=nothing)
        o = new()
        validate_property(IoK8sApiNetworkingV1beta1IngressBackend, Symbol("resource"), resource)
...
const _property_map_IoK8sApiNetworkingV1beta1IngressBackend = Dict{Symbol,Symbol}(Symbol("resource")=>Symbol("resource"), Symbol("serviceName")=>Symbol("serviceName"), Symbol("servicePort")=>Symbol("servicePort"))
const _property_types_IoK8sApiNetworkingV1beta1IngressBackend = Dict{Symbol,String}(Symbol("resource")=>"IoK8sApiCoreV1TypedLocalObjectReference", Symbol("serviceName")=>"String", Symbol("servicePort")=>"IoK8sApimachineryPkgUtilIntstrIntOrString")
