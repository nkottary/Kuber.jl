...
mutable struct IoK8sApiNetworkingV1beta1IngressSpec <: SwaggerModel
    ...
    function IoK8sApiNetworkingV1beta1IngressSpec(;backend=nothing, ingressClassName=nothing, rules=nothing, tls=nothing)
        o = new()
        validate_property(IoK8sApiNetworkingV1beta1IngressSpec, Symbol("backend"), backend)
        setfield!(o, Symbol("backend"), backend)
        validate_property(IoK8sApiNetworkingV1beta1IngressSpec, Symbol("ingressClassName"), ingressClassName)
...
const _property_map_IoK8sApiNetworkingV1beta1IngressSpec = Dict{Symbol,Symbol}(Symbol("backend")=>Symbol("backend"), Symbol("ingressClassName")=>Symbol("ingressClassName"), Symbol("rules")=>Symbol("rules"), Symbol("tls")=>Symbol("tls"))
const _property_types_IoK8sApiNetworkingV1beta1IngressSpec = Dict{Symbol,String}(Symbol("backend")=>"IoK8sApiNetworkingV1beta1IngressBackend", Symbol("ingressClassName")=>"String", Symbol("rules")=>"Vector{IoK8sApiNetworkingV1beta1IngressRule}", Symbol("tls")=>"Vector{IoK8sApiNetworkingV1beta1IngressTLS}")
