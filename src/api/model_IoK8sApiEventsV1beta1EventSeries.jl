...
mutable struct IoK8sApiEventsV1beta1EventSeries <: SwaggerModel
    ...
    function IoK8sApiEventsV1beta1EventSeries(;count=nothing, lastObservedTime=nothing)
        o = new()
...
const _property_map_IoK8sApiEventsV1beta1EventSeries = Dict{Symbol,Symbol}(Symbol("count")=>Symbol("count"), Symbol("lastObservedTime")=>Symbol("lastObservedTime"))
const _property_types_IoK8sApiEventsV1beta1EventSeries = Dict{Symbol,String}(Symbol("count")=>"Int32", Symbol("lastObservedTime")=>"IoK8sApimachineryPkgApisMetaV1MicroTime")
