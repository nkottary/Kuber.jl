...
@doc raw"""Endpoint represents a single logical \&quot;backend\&quot; implementing a service.
    ...
    - nodeName::String : nodeName represents the name of the Node hosting this endpoint. This can be used to determine endpoints local to a Node. This field can be enabled with the EndpointSliceNodeName feature gate.
...
mutable struct IoK8sApiDiscoveryV1beta1Endpoint <: SwaggerModel
    ...
    function IoK8sApiDiscoveryV1beta1Endpoint(;addresses=nothing, conditions=nothing, hostname=nothing, nodeName=nothing, targetRef=nothing, topology=nothing)
        o = new()
        ...
        validate_property(IoK8sApiDiscoveryV1beta1Endpoint, Symbol("nodeName"), nodeName)
...
const _property_map_IoK8sApiDiscoveryV1beta1Endpoint = Dict{Symbol,Symbol}(Symbol("addresses")=>Symbol("addresses"), Symbol("conditions")=>Symbol("conditions"), Symbol("hostname")=>Symbol("hostname"), Symbol("nodeName")=>Symbol("nodeName"), Symbol("targetRef")=>Symbol("targetRef"), Symbol("topology")=>Symbol("topology"))
const _property_types_IoK8sApiDiscoveryV1beta1Endpoint = Dict{Symbol,String}(Symbol("addresses")=>"Vector{String}", Symbol("conditions")=>"IoK8sApiDiscoveryV1beta1EndpointConditions", Symbol("hostname")=>"String", Symbol("nodeName")=>"String", Symbol("targetRef")=>"IoK8sApiCoreV1ObjectReference", Symbol("topology")=>"Dict{String, String}")
