...
mutable struct IoK8sApiNetworkingV1beta1HTTPIngressPath <: SwaggerModel
    ...
    function IoK8sApiNetworkingV1beta1HTTPIngressPath(;backend=nothing, path=nothing, pathType=nothing)
        o = new()
        ...
        validate_property(IoK8sApiNetworkingV1beta1HTTPIngressPath, Symbol("pathType"), pathType)
        setfield!(o, Symbol("pathType"), pathType)
        o
    end
end # type IoK8sApiNetworkingV1beta1HTTPIngressPath

const _property_map_IoK8sApiNetworkingV1beta1HTTPIngressPath = Dict{Symbol,Symbol}(Symbol("backend")=>Symbol("backend"), Symbol("path")=>Symbol("path"), Symbol("pathType")=>Symbol("pathType"))
const _property_types_IoK8sApiNetworkingV1beta1HTTPIngressPath = Dict{Symbol,String}(Symbol("backend")=>"IoK8sApiNetworkingV1beta1IngressBackend", Symbol("path")=>"String", Symbol("pathType")=>"String")
