...
mutable struct IoK8sApiCoreV1Secret <: SwaggerModel
    ...
    function IoK8sApiCoreV1Secret(;apiVersion=nothing, data=nothing, immutable=nothing, kind=nothing, metadata=nothing, stringData=nothing, type=nothing)
        o = new()
        ...
        validate_property(IoK8sApiCoreV1Secret, Symbol("immutable"), immutable)
...
const _property_map_IoK8sApiCoreV1Secret = Dict{Symbol,Symbol}(Symbol("apiVersion")=>Symbol("apiVersion"), Symbol("data")=>Symbol("data"), Symbol("immutable")=>Symbol("immutable"), Symbol("kind")=>Symbol("kind"), Symbol("metadata")=>Symbol("metadata"), Symbol("stringData")=>Symbol("stringData"), Symbol("type")=>Symbol("type"))
const _property_types_IoK8sApiCoreV1Secret = Dict{Symbol,String}(Symbol("apiVersion")=>"String", Symbol("data")=>"Dict{String, Vector{UInt8}}", Symbol("immutable")=>"Bool", Symbol("kind")=>"String", Symbol("metadata")=>"IoK8sApimachineryPkgApisMetaV1ObjectMeta", Symbol("stringData")=>"Dict{String, String}", Symbol("type")=>"String")
