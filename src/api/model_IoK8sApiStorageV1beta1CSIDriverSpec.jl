...
mutable struct IoK8sApiStorageV1beta1CSIDriverSpec <: SwaggerModel
    ...
    tokenRequests::Any # spec type: Union{ Nothing, Vector{IoK8sApiStorageV1beta1TokenRequest} } # spec name: tokenRequests
    volumeLifecycleModes::Any # spec type: Union{ Nothing, Vector{String} } # spec name: volumeLifecycleModes

    function IoK8sApiStorageV1beta1CSIDriverSpec(;attachRequired=nothing, fsGroupPolicy=nothing, podInfoOnMount=nothing, requiresRepublish=nothing, storageCapacity=nothing, tokenRequests=nothing, volumeLifecycleModes=nothing)
        o = new()
        ...
        validate_property(IoK8sApiStorageV1beta1CSIDriverSpec, Symbol("fsGroupPolicy"), fsGroupPolicy)
        ...
        validate_property(IoK8sApiStorageV1beta1CSIDriverSpec, Symbol("requiresRepublish"), requiresRepublish)
        setfield!(o, Symbol("requiresRepublish"), requiresRepublish)
        validate_property(IoK8sApiStorageV1beta1CSIDriverSpec, Symbol("storageCapacity"), storageCapacity)
        setfield!(o, Symbol("storageCapacity"), storageCapacity)
        validate_property(IoK8sApiStorageV1beta1CSIDriverSpec, Symbol("tokenRequests"), tokenRequests)
